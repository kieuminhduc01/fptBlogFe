    ...
    <>
      ...
      <MainContainer>
        ...
        <div className="position-relative d-none d-md-block">
          ...
          <div className="right-0 z-index--100 bg-body-secondary top--44vh-xxl top--34vh-xl top--34vh-lg top--30vh-md h-60vh-xxl h-50vh-xl h-50vh-lg w-74vw-xxl w-73vw-xl w-71vw-lg position-absolute d-none d-lg-block"></div>
