  ...
  return (
    <>
      <div className="position-relative d-none d-lg-block">
        <div className="vertical-line position-absolute z-index-dropdown top-260px-xxl top-260px-xl top-260px-lg right-38vw-xxl right-38vw-xl right-42vw-global d-none d-md-inline-block"></div>
      </div>
      <StatusAlert />
      <MainContainer>
        <Swiper
        ...
        <div className="position-relative d-none d-md-block">
          <div className="vertical-line position-absolute d-none d-lg-inline-block left-52vw-xxl left-48vw-xl left-44vw-lg bottom--16vh-xxl bottom--14vh-xl bottom--12vh-lg bottom--10vh-md"></div>
