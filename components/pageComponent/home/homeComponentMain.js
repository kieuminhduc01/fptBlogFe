    ...
    <>
      ...
      <MainContainer>
        ...
        <div className="position-relative d-none d-md-block">
          <div className="vertical-line position-absolute d-none d-lg-inline-block  left-40vw-xxl left-40vw-xl left-40vw-lg left-41vw-md bottom--16vh-xxl bottom--16vh-xl bottom--16vh-lg bottom--10vh-md"></div>
          <div
            style={{ right: 0, zIndex: -10 }}
            className="bg-body-secondary top--40vh-xxl top--34vh-xl top--34vh-lg top--30vh-md h-500px-xxl h-400px-xl h-400px-lg w-66vw-xxl w-66vw-xl w-66vw-lg position-absolute d-none d-lg-block"
          ></div>
